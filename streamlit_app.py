"""
Listn Intel — entry point.

This Week's Moves: two cards (creative + content) and three supporting stats.
Both cards are derived live from the data files in data/.
"""
...
# Load .env for local dev. On Streamlit Cloud, st.secrets takes over.
try:
